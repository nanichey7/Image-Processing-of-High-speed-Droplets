...
from code_with_initialframeExclusion_and_impurities import initial_frame_ids, is_first_frame, is_second_frame
            ...
            if not object_histories[obj_id]['stabilized']:
                ...
                if len(width_history) == history_length:
                    ...
                    if max_width_change <= size_change_threshold and max_height_change <= size_change_threshold:
                        ...
                        if obj_id not in initial_frame_ids:
                            ...
                            if mean_width <= chamber_height:
                                ...
                                volume = ((H * W - (4 - np.pi) * ((2 / H) + (2 / W)) ** -2 - c * H ** 2) * (
                                        L - W / 3)) / 1000
                                print(
                                    f"id={obj_id}, plug, length = {W}, width= {L}, height = {H}, volume = {volume} pL\n")
